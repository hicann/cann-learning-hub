#include "../op_kernel/bracket_match_lite_tiling.h"
...
{
    BracketMatchLiteTilingData *tiling = context->GetTilingData<BracketMatchLiteTilingData>();
...
namespace ops {
class BracketMatchLite : public OpDef {
public:
    explicit BracketMatchLite(const char* name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
            .DataType({ge::DT_INT8})
