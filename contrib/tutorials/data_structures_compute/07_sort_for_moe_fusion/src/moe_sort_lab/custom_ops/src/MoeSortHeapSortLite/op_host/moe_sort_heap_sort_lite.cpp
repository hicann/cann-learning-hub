...
static ge::graphStatus TilingFunc(gert::TilingContext *context)
{
    ...
    MoeSortHeapSortLiteTilingData tiling;
...
namespace ops {
class MoeSortHeapSortLite : public OpDef {
public:
    explicit MoeSortHeapSortLite(const char *name) : OpDef(name)
    {
