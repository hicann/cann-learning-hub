#ifndef REDUCE_MAX_LITE_TILING_H
#define REDUCE_MAX_LITE_TILING_H

#ifndef REDUCE_MAX_LITE_KERNEL_UNDEF_DT_MACROS
#define REDUCE_MAX_LITE_KERNEL_UNDEF_DT_MACROS
#ifdef DT_FLOAT
#undef DT_FLOAT
#endif
#ifdef DT_FLOAT16
