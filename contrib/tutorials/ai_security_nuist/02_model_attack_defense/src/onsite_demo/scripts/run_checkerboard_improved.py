...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="运行 Checkerboard Trigger Improved / 棋盘触发器改进实验")
...
def main() -> dict:
    ...
    print(f"checkerboard clean accuracy：{result['eval_summary']['clean_accuracy']:.4f}")
    print(f"checkerboard ASR：{result['eval_summary']['attack_success_rate']:.4f}")
