...
| Lab | 内容概要 | 实验环境 | 链接 |
| --- | --- | --- | --- |
| 实验5.1 Ascend C 自定义算子开发循序渐进教程 | 四个递进式实验，引导逐步理解 Ascend C 算子开发核心概念与编程范式 | CANNLab在线实验 | [查看](./Lab5_1/lab5.1_ascendc_CANN_operator.ipynb) |
...
| 实验5.3 ONNX 模型到 OM 模型转换与验证CANNLab在线实验 | 以 SimpleCNN（MNIST）为载体，完整走通 ONNX → ATC → OM → AscendCL 推理链路，对比多种模型格式部署效果 | CANNLab在线实验 | [查看](./Lab5_3/lab5.3_cann_sandbox_onnx_to_om.ipynb) |
...
- [第5章 智能系统部署与实现.pdf](https://www.qmpan.com/f/zLjghm/Chapter5_Intelligent_System_Deployment_and_Implementation.pdf)
