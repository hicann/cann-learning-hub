...
def grade(user_globals):
    ...
    answer_file = os.path.join(notebook_dir, 'answer', '05_answer.txt')
    if not os.path.exists(answer_file):
        answer_file = './answer/05_answer.txt'
    if not os.path.exists(answer_file):
        answer_file = os.path.join(notebook_dir, '06_vision_dev', 'answer', '05_answer.txt')
