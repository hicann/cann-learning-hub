...
def grade(user_globals):
    ...
    answer_file = os.path.join(notebook_dir, 'answer', '06_answer.txt')
    if not os.path.exists(answer_file):
        answer_file = './answer/06_answer.txt'
    if not os.path.exists(answer_file):
        answer_file = os.path.join(notebook_dir, '06_vision_dev', 'answer', '06_answer.txt')
