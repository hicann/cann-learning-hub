...
| Lab | 内容概要 | 实验环境 | 链接 |
| --- | --- | --- | --- |
| 实验6.1 昇腾 DVPP 和 AIPP 图片及视频处理实验 | DVPP 数字视频预处理与 AIPP AI 预处理两大硬件加速能力，OpenCV（CPU）与 DVPP（NPU）处理路径对比 | CANNLab在线实验 | [查看](./Lab6_1/lab6.1_dvpp_aipp_cann.ipynb) |
| 实验6.2 基于 DVPP 与 AIPP 的 YOLO 目标检测与 DeepSort 多目标追踪 | YOLOv8 目标检测模型部署与 DeepSort 多目标追踪，DVPP 硬件视频解码与 AIPP 预处理加速 | CANNLab在线实验 | [查看](./Lab6_2/lab6.2_dvpp_aipp_yolo_deepsort_cann.ipynb) |
