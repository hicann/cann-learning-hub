...
def grade(user_globals):
    ...
    answer_file = os.path.join(notebook_dir, 'answer', '04_answer.txt')
    if not os.path.exists(answer_file):
        answer_file = './answer/04_answer.txt'
    if not os.path.exists(answer_file):
        answer_file = os.path.join(notebook_dir, '07_nlp_dev', 'answer', '04_answer.txt')
