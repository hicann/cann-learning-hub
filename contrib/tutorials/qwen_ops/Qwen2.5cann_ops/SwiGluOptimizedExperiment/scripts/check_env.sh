...
echo "=== SwiGLU Optimized Environment Check ==="
...
python3 -c "import torch, numpy" >/dev/null && echo "[OK] Python torch/numpy available" || { echo "[FAIL] torch and numpy required"; exit 1; }
