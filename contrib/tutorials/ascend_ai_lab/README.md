...
| 环境 | 状态 | 说明 |
| --- | --- | --- |
| CANNLab 云开发环境 | ✅ | 见 [CANNLab 环境体验指南](../../../docs/CANNLab_env_experience_guide.md)；用于第 02、03、05、06 章实验；第 03 章已验证 YOLO 单卡 NPU 训练与 MSPROF 分析；NPU 镜像模板名称：cann_9.0.0 py3.11-A2-arm；Python 内核版本：3.11.4 |
