...
| 序号 | 课程 | 课程内容 | 状态 |
| :---: | :--- | :--- | :---: |
| 5 | [医学模型微调](https://gitcode.com/cann/cann-learning-hub/tree/test/contrib/tutorials/swanlab_examples/qwen3_medical_sft) | Qwen3 医学领域 SFT + SwanLab 可视化 | ✅ 已上线 |
...
> 📖 **配套课件**：[SFT 训练流程](https://gitcode.com/cann/cann-learning-hub/tree/test/tutorials/training_pipeline/01-sft) ｜ [RL 训练流程](https://gitcode.com/cann/cann-learning-hub/tree/test/tutorials/training_pipeline/02-rl)

| 序号 | 课程（实践） | 课程内容 | 运行方式 |
| :---: | :--- | :--- | :--- |
| 9 | [SFT 训练系列（初阶）](https://gitcode.com/cann/cann-learning-hub/tree/test/tutorials/training_pipeline/01-sft) | 环境搭建 Torchtitan / Qwen3-1.7B 基线跑通 + Profiling / 应用融合算子 / 性能对比 | [open in CANNLab](https://gitcode.com/org/cann/cannlab) |
| 10 | [RL 训练系列（初阶）](https://gitcode.com/cann/cann-learning-hub/tree/test/tutorials/training_pipeline/02-rl) | Qwen3-1.7B 基线跑通 / 训推分离架构 / Wordle 评分 / vLLM-Ascend 适配 / 问题定位 | [open in CANNLab](https://gitcode.com/org/cann/cannlab) |
...
| 9 | [Vector 算子开发](https://gitcode.com/cann/cann-learning-hub/tree/test/tutorials/vector_operator_development) | Vector 算子开发实战 | 🔍 建设中 |
| 10 | [Conv 算子开发实战](./tutorials/conv_operator_development) | 卷积算子开发核心概念与实践 | [在线体验](./tutorials/conv_operator_development) |
...
<tr>
<td><b>⚙️ 算子开发</b></td>
<td><a href="./tutorials/ascendc_operator_development_light">Kernel 直调版</a> · <a href="https://gitcode.com/cann/cann-learning-hub/tree/test/contrib/tutorials/d2l_ai_pypto">d2l PyPTO 实战</a> · <a href="https://gitcode.com/cann/cann-learning-hub/tree/test/tutorials/pyasc_operator_development">PyASC 入门</a><br/><sub>算子基础概念、编程范式、PyPTO Tensor 编程、PyASC 函数开发</sub></td>
<td><a href="./tutorials/ascendc_operator_development">算子工程版</a> · <a href="./tutorials/conv_operator_development">Conv 算子实战</a> · <a href="https://gitcode.com/cann/cann-learning-hub/tree/test/tutorials/vector_operator_development">Vector 算子实战</a><br/><sub>Vector/Cube/融合算子开发、工程化流程、卷积与矢量算子实战</sub></td>
...
<tr>
<td><b>🔗 图框架</b></td>
<td><a href="https://gitcode.com/cann/cann-learning-hub/tree/test/tutorials/ge_development">GE 图引擎</a> · <a href="https://gitcode.com/cann/cann-learning-hub/tree/test/tutorials/TorchAir_development">TorchAir</a> · <a href="https://gitcode.com/cann/cann-learning-hub/tree/test/tutorials/autofusion_development">AutoFusion</a><br/><sub>图编译执行、图模式优化、自动融合</sub></td>
<td>🚧 建设中<br/><sub>图构建/编译配置/自定义算子入图/自定义融合pass/静态&动态shape</sub></td>
<td>🚧 建设中<br/><sub>自动融合原理/融合策略求解/SuperKernel等</sub></td>
</tr>
<tr>
<td><b>📡 通信</b></td>
<td><a href="./tutorials/hixl_development">HiXL 单边通信</a> · 集合通信 🚧<br/><sub>单边通信基础、集合通信基础</sub></td>
...
<tr>
<td><b>🤖 CANNBot</b></td>
<td><a href="https://gitcode.com/cann/cannbot-skills">CANNBot</a> · <a href="https://gitcode.com/cann/cann-learning-hub/tree/test/contrib/tutorials/data_structure_for_hpc">HPC 数据结构</a><br/><sub>开发辅助、高性能计算基础</sub></td>
<td>🚧 建设中</td>
<td>🚧 建设中</td>
</tr>
</table>
...
| 类别 | 案例 | 简介 | 原始文档 | 状态 |
| :--- | :--- | :--- | :--- | :---: |
| 监督微调 | 医学模型微调 | Qwen3 医学领域 SFT 实战 | [查看](https://gitcode.com/cann/cann-learning-hub/tree/test/contrib/tutorials/swanlab_examples/qwen3_medical_sft) · [原文](https://docs.swanlab.cn/course/llm_train_course/03-sft/4.qwen3-medical-finetune/) | ✅ 已上线 |
