...
| Notebook | Link | 状态 |
|--|--|--|
| 1. 章节介绍 | [在线体验](https://ai.gitcode.com/user/username/notebookcann?repoUrl=https://gitcode.com/cann/cann-learning-hub.git&ttl=120&diskSize=40Gi&path=reference_practice/model_inference_optimization/qwen3_8b&scanFilePath=reference_practice/model_inference_optimization/qwen3_8b/01_chapter_intro.ipynb) | ✅ 已发布 |
| 2. Baseline 跑通 | [在线体验](https://ai.gitcode.com/user/username/notebookcann?repoUrl=https://gitcode.com/cann/cann-learning-hub.git&ttl=120&diskSize=40Gi&path=reference_practice/model_inference_optimization/qwen3_8b&scanFilePath=reference_practice/model_inference_optimization/qwen3_8b/02_baseline_inference.ipynb) | ✅ 已发布 |
| 3. Profiling 分析 | [在线体验](https://ai.gitcode.com/user/username/notebookcann?repoUrl=https://gitcode.com/cann/cann-learning-hub.git&ttl=120&diskSize=40Gi&path=reference_practice/model_inference_optimization/qwen3_8b&scanFilePath=reference_practice/model_inference_optimization/qwen3_8b/03_profiling_analysis.ipynb) | ✅ 已发布 |
| 4. Dense RMSNorm NPU 融合路径优化验证 | [在线体验](https://ai.gitcode.com/user/username/notebookcann?repoUrl=https://gitcode.com/cann/cann-learning-hub.git&ttl=120&diskSize=40Gi&path=reference_practice/model_inference_optimization/qwen3_8b&scanFilePath=reference_practice/model_inference_optimization/qwen3_8b/04_npu_optimization.ipynb) | ✅ 已发布 |
| 5. 自定义量化 A8W8 matmul 算子开发 | [在线体验](https://ai.gitcode.com/user/username/notebookcann?repoUrl=https://gitcode.com/cann/cann-learning-hub.git&ttl=120&diskSize=40Gi&path=reference_practice/model_inference_optimization/qwen3_8b&scanFilePath=reference_practice/model_inference_optimization/qwen3_8b/05_quantized_a8w8_matmul_operator_development.ipynb) | ✅ 已发布 |
| 6. 自定义 matmul 算子接入 Qwen3-8B | [在线体验](https://ai.gitcode.com/user/username/notebookcann?repoUrl=https://gitcode.com/cann/cann-learning-hub.git&ttl=120&diskSize=40Gi&path=reference_practice/model_inference_optimization/qwen3_8b&scanFilePath=reference_practice/model_inference_optimization/qwen3_8b/06_custom_matmul_operator_integration_with_qwen3_8b.ipynb) | ✅ 已发布 |
