...
In CANN Community Edition 9.2.0 or later, test different multi-stream parallel modes, determine the optimal value for this sample under the specified environment and test conditions, and submit a PR with the following result:
...
atc --model=yolov13n.onnx \
    ...
    --soc_version=<detected SOC_VERSION> \
    --input_shape="images:1,3,640,640" \
    --output_type=FP32 \
