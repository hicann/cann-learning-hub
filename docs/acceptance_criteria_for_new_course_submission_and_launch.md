...
| 2 | 课程大纲提评审，阐述能力的分层设计逻辑 | 课程组、committer | 说明初级、中级、高级能力递进关系，以及各阶段考核方式。 |
...
| 5 | 课程组组长 & committer评审 PR | 课程组组长、committer | 依据准合入 Checklist 检查课程结构、内容质量、代码可执行性和能力递进设计。 |
| 6 | 达到准入标准，合入 test 分支 | 课程组组长、committer | 所有硬性验收项通过，条件项结论明确后合入 test 分支。 |
