...
![conventional_training_checkpointing_process](images/conventional_training_checkpointing_process.png)<html><center>常规训练任务的交替过程(训练和检查点)</center></html>

传统的异常恢复方法系统采用周期性检查点机制，系统每隔一段时间把模型参数和优化器状态保存下来，一旦发生故障，就回滚到上一个检查点，重新计算从那之后的所有步骤：

![traditional_failure_recovery_workflow](images/traditional_failure_recovery_workflow.png)
<html>
...
![proactive_failure_detection_architecture](images/proactive_failure_detection_architecture.png)
...
![multi_layer_fault_awareness_reporting](images/multi_layer_fault_awareness_reporting.png)
...
![faulty_node_replacement_and_restart](images/faulty_node_replacement_and_restart.png)
...
![parallel_tcpstore_scaling_optimization](images/parallel_tcpstore_scaling_optimization.png)
...
![rank_table_update_time_comparison](images/rank_table_update_time_comparison.png)
...
![flashrecovery_task_restart_workflow](images/flashrecovery_task_restart_workflow.png)
...
![optimizer_step_barrier_training_process](images/optimizer_step_barrier_training_process.png)
...
![forward_backward_failure_recovery](images/forward_backward_failure_recovery.png)
...
![optimizer_step_failure_recovery](images/optimizer_step_failure_recovery.png)
...
![flashrecovery_recovery_overhead_analysis](images/flashrecovery_recovery_overhead_analysis.png)
...
![traditional_recovery_time_comparison](images/traditional_recovery_time_comparison.png)
...
![flashrecovery_total_recovery_time_comparison](images/flashrecovery_total_recovery_time_comparison.png)
